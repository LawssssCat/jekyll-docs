...
Most of the typography here is based on markdown rendering of Jekyll and [Kramdown](https://kramdown.gettalong.org/index.html) is the default Markdown renderer for Jekyll. (see [here]({% link _markdown/markdown.md %}) for more details about markdown and Kramdown in Jekyll.)
